...
;// Materials Cloud bands structure widget v1.2.2
// https://www.materialscloud.org
// Contributors: Materials Cloud team <info@materialscloud.org>
// (c) 2021, Released under the MIT License

var zip=function(){var n=[].slice.call(arguments);return(0===n.length?[]:n.reduce(function(t,e){return t.length<e.length?t:e})).map(function(t,e){return n.map(function(t){return t[e]})})};function getPathStringFromPathArray(t){var e=[],n="";return t.forEach(function(t){0===e.length?e+=t[0]:n!=t[0]&&(e+="|"+t[0]),e+="-",e+=t[1],n=t[1]}),e}function getPathArrayFromPathString(t){var e=[];return t.split("|").forEach(function(t){t=t.split("-").map(function(t){return t.trim()}).filter(function(t){return""!==t});zip(t.slice(0,t.length-1),t.slice(1)).forEach(function(t){e.push([t[0],t[1]])})}),e}function getValidPointNames(t){var e=[];t.forEach(function(t){t.hasOwnProperty("paths")&&t.paths.forEach(function(t){e.push(t.from),e.push(t.to)})});t=Array.from(new Set(e));return t.sort(),t}function BandPlot(t,e,n){this.divID=t,this.allData=[],this.allSeries=[],this.allColorInfo=[],this.currentPath=[],this.fermiEnergy=e,this.yLimit=n,this.yLabel="",void 0!==this.myChart&&this.myChart.destroy()}BandPlot.prototype.addBandStructure=function(t,e){var n,r=["#555555","#e41a1c","#377eb8","#4daf4a","#984ea3","#ff7f00"];void 0===e&&(n=this.allColorInfo.length,e=[(r=tinycolor(r[n%r.length])).toHexString(),r.darken(20).toHexString(),r.brighten(20).toHexString()]),this.allColorInfo.push(e),this.allData.push(t)},BandPlot.prototype.initChart=function(t){var e=this,n={type:"scatter",data:{datasets:this.allSeries},options:{legend:{display:!1},animation:{duration:0},hover:{animationDuration:0,mode:null},responsiveAnimationDuration:0,elements:{line:{tension:0}},responsive:!0,maintainAspectRatio:!1,tooltips:!1,scales:{xAxes:[{display:!0,ticks:{callback:function(t,e,n){return this.options.customTicks[e].label}},customTicks:t,afterBuildTicks:function(t,e){return t.options.customTicks.map(function(t){return t.value})}}],yAxes:[{display:!0,ticks:{callback:function(t,e,n){if(0!==e&&e!=n.length-1)return t}},scaleLabel:{display:!0},gridLines:{display:!1}}]},zoom:{enabled:!0,mode:"y",drag:!0}}};e.yLimit&&(n.options.scales.yAxes[0].ticks.min=e.yLimit.ymin,n.options.scales.yAxes[0].ticks.max=e.yLimit.ymax),e.xLimit&&(n.options.scales.xAxes[0].ticks.min=e.xLimit.xmin,n.options.scales.xAxes[0].ticks.max=e.xLimit.xmax),e.yLabel&&(n.options.scales.yAxes[0].scaleLabel.labelString=e.yLabel);t=document.getElementById(this.divID).getContext("2d");e.myChart=new Chart(t,n)},BandPlot.prototype.getDefaultPath=function(){return 0<this.allData.length?this.allData[0].path:[]},BandPlot.prototype.updateBandPlot=function(t,e){var f=this,n=null;void 0===e&&(e=!1);var m,a,n=void 0===t?f.getDefaultPath():t,r=!1;f.currentPath.length!=n.length?r=!0:zip(f.currentPath,n).forEach(function(t){t[0][0]!=t[1][0]&&(r=!0),t[0][1]!=t[1][1]&&(r=!0)}),(r||e)&&(f.currentPath=n,m=0,a=[],f.allSeries=[],n.forEach(function(c,t){0===a.length?a.push([m,c[0]]):a[a.length-1][1]!=c[0]&&(a[a.length-1][1]+="|"+c[0]);var r,u=!1,h=null;f.allData.forEach(function(t,a){var i=function(t,e){for(var n=0;n<e.length;n++){var r=e[n];if(r.from==t[0]&&r.to==t[1])return{segment:r,reverse:!1};if(r.from==t[1]&&r.to==t[0])return{segment:r,reverse:!0}}return null}(c,t.paths);if(i){u=!0;var s=[],e=i.segment.x.length;if(i.reverse)for(r=i.segment.x.length-1;0<=r;r--)s.push(i.segment.x[e-1]-i.segment.x[r]);else for(r=0;r<e;r++)s.push(i.segment.x[r]-i.segment.x[0]);var o=i.segment.two_band_types||!1,l=i.segment.values.length;null===h&&(h=s[s.length-1]);var n;if(0<s[s.length-1])for(n=h/s[s.length-1],r=0;r<s.length;r++)s[r]*=n;0<h&&i.segment.values.forEach(function(t,e){var n=[];r=i.reverse?t.slice().reverse():t,f.fermiEnergy&&(r=r.map(function(t){return t-f.fermiEnergy})),zip(s,r).forEach(function(t){n.push({x:t[0]+m,y:t[1]})});var t=f.allColorInfo[a],r=null,r=o?2*e<l?t[1]:t[2]:t[0],r={label:c[0]+"-"+c[1]+"."+e,borderColor:r,borderWidth:2,data:n,fill:!1,showLine:!0,pointRadius:0};f.allSeries.push(r)})}}),m+=u&&0<h?h:.1,a.push([m,c[1]])}),n=f.updateTicks(a).map(function(t,e){return{value:t[0],label:t[1]}}),f.xLimit={xmin:0,xmax:m},f.yLabel=f.allData[0].Y_label,void 0===f.yLabel&&(f.yLabel="Electronic bands (eV)"),void 0===f.myChart?f.initChart(n):(f.myChart.options.scales.xAxes[0].customTicks=n,f.myChart.data.datasets=f.allSeries,f.myChart.options.scales.xAxes[0].ticks.max=m,f.myChart.update()))},BandPlot.prototype.resetZoom=function(){var t=this;t.myChart.resetZoom(),t.myChart.options.scales.xAxes[0].ticks.min=t.xLimit.xmin,t.myChart.options.scales.xAxes[0].ticks.max=t.xLimit.xmax,t.myChart.update()},BandPlot.prototype.updateTicks=function(t){var a,e=function(t,e){var n={};for(a=0;a<e.length;a++)n[e[a][0]]=e[a][1];var t=getValidPointNames(t),r=-1==t.findIndex(function(t){return"GAMMA"==t})&&-1!=t.findIndex(function(t){return"G"==t})?function(t){return"G"==t&&(t="Γ"),t=(t=t.replace(/\-/gi,"—")).replace(/(\d)/gi,function(t,e,n,r){switch(e){case"0":return"₀";case"1":return"₁";case"2":return"₂";case"3":return"₃";case"4":return"₄";case"5":return"₅";case"6":return"₆";case"7":return"₇";case"8":return"₈";case"9":return"₉"}return e})}:function(t){return t=(t=(t=(t=(t=(t=t.replace(/GAMMA/gi,"Γ")).replace(/DELTA/gi,"Δ")).replace(/SIGMA/gi,"Σ")).replace(/LAMBDA/gi,"Λ")).replace(/\-/gi,"—")).replace(/_(.)/gi,function(t,e,n,r){switch(e){case"0":return"₀";case"1":return"₁";case"2":return"₂";case"3":return"₃";case"4":return"₄";case"5":return"₅";case"6":return"₆";case"7":return"₇";case"8":return"₈";case"9":return"₉"}return e})};return function(t){return void 0===t?t:r(t)}}(this.allData,t);return t.map(function(t){return[t[0],e(t[1])]})};